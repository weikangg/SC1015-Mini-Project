...
# 🧑🏽‍🤝‍🧑🏽 Contributors
* Chong Wei Kang (@weikangg): Problem Statement, Motivation, Data Preparation
* Joel Tan (@pluffff): Deep Learning with TensorFlow, Conclusion
* Sua Qi Rong (@Soqoro): EDA, Multi-variate Linear Regression, Random Forest Regression
...
- Encoding of Category Variables: Label Encoder to encode "Status" into 0 and 1. 0 represents Developed Countries while 1 represents Developing Countries</code></pre>
